        ...
        <div className="space-y-6 md:space-y-8 animate-fadeIn text-left">
            ...
            <div className="bg-[var(--color-surface-lowest)] border border-[var(--color-outline-variant)] rounded-xl shadow-sm p-4 md:p-8 max-w-xl mx-auto space-y-4 md:space-y-6 border-solid">
                ...
                <form onSubmit={handleSaveProfile} className="space-y-4 md:space-y-6">
                    <div className="space-y-3 md:space-y-4">
                        <div>
                            ...
                            <input 
                                ...
                                className="w-full p-2.5 md:p-3.5 bg-[var(--color-surface-lowest)] border border-[var(--color-outline-variant)] rounded-xl text-[12px] md:text-[13px] font-semibold outline-none focus:border-[var(--color-primary)] transition-all shadow-sm border-solid text-[var(--color-on-surface)]"
                                required
                            />
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input 
                                    ...
                                    disabled
                                    className="w-full p-2.5 md:p-3.5 bg-[var(--color-surface-low)] border border-[var(--color-outline-variant)] text-slate-400 rounded-xl text-[12px] md:text-[13px] font-semibold cursor-not-allowed outline-none border-solid"
                                />
                            </div>
                            <div>
                        ...
                        <div className="pt-2">
                            ...
                            {editableProfile.telegram_id ? (
                                <div className="p-2.5 md:p-3.5 bg-slate-50 border border-slate-200 rounded-xl text-[11px] md:text-[12.5px] font-semibold flex items-center justify-between">
                                ...
                                <div className="p-2.5 md:p-3.5 bg-slate-50 border border-slate-200 rounded-xl text-[11px] md:text-[12.5px] font-semibold flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-2 md:py-2.5 bg-[#229ED9] hover:bg-[#1c8ec4] text-white text-[11px] font-extrabold rounded-xl transition-all shadow-sm border-none cursor-pointer flex items-center gap-1.5"
                                    >
                    ...
                    <div className="border-t border-[var(--color-outline-variant)] pt-4 md:pt-5 space-y-3 md:space-y-4">
                    ...
                    <button 
                        type="submit"
                        className="w-full py-2.5 md:py-3.5 bg-[var(--color-primary)] hover:bg-[var(--color-primary)]/90 text-white text-[12.5px] font-bold uppercase rounded-xl transition-all shadow-sm cursor-pointer active:scale-98 hover:-translate-y-0.5 duration-200 border-none"
                    >
                        Save Settings
                    </button>
                </form>
