        ...
        <div className="space-y-6 md:space-y-8 animate-fadeIn text-left relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                ...
                <div className="bg-zinc-900/70 backdrop-blur-xl border border-white/10 rounded-[24px] p-4 md:p-6 shadow-sm hover:border-white/20 hover:shadow-lg transition-all duration-300 space-y-3 md:space-y-4 text-left">
                    ...
                    <p className="text-[12.5px] text-slate-300 font-semibold leading-relaxed">
                    ...
                    <div className="pt-2">
                        <a 
                            ...
                            className="px-4 py-1.5 md:py-2 bg-white/5 hover:bg-white/10 text-white border border-white/10 hover:border-white/20 text-[11px] font-semibold rounded-xl shadow-sm inline-flex items-center gap-1.5 transition-all cursor-pointer decoration-none"
                        >
                            {lang === 'EN' ? 'Get Directions' : 'दिशा-निर्देश प्राप्त करें'} <MapPin size={12} className="text-blue-400" />
                        </a>
                    </div>
                </div>
                ...
                <div className="bg-zinc-900/70 backdrop-blur-xl border border-white/10 rounded-[24px] p-4 md:p-6 shadow-sm hover:border-white/20 hover:shadow-lg transition-all duration-300 space-y-3 md:space-y-4 text-left">
                    ...
                    <span className="text-[9.5px] text-emerald-400 bg-emerald-500/10 px-2.5 py-1 rounded-lg border border-emerald-500/20 uppercase font-extrabold inline-flex items-center gap-1">
                        <ShieldCheck size={10} />
                ...
                <div className="bg-zinc-900/70 backdrop-blur-xl border border-white/10 rounded-[24px] p-4 md:p-6 shadow-sm hover:border-white/20 hover:shadow-lg transition-all duration-300 space-y-3 md:space-y-4 text-left">
                    ...
                    <div className="pt-2">
                        <a 
                            ...
                            className="px-4.5 py-2 md:py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white text-[11px] font-semibold rounded-xl inline-flex items-center gap-1.5 shadow-sm transition-all border-none cursor-pointer decoration-none"
                        >
