        ...
        <div className="space-y-6 md:space-y-8 text-left animate-fadeIn pb-20">
            ...
            <div className="space-y-3 pt-2">
                ...
                {exams && exams.filter(ex => ex.end_date && new Date(ex.end_date) >= new Date()).length > 0 ? (
                    ...
                    <div className="text-center py-8 bg-white/[0.01] backdrop-blur-sm border border-white/10 border-dashed rounded-2xl flex flex-col items-center justify-center gap-2">
            ...
            <div className="space-y-3 pt-3">
                ...
                {history && history.length > 0 ? (
                    ...
                    <div className="text-center py-8 bg-white/[0.01] backdrop-blur-sm border border-white/10 border-dashed rounded-2xl flex flex-col items-center justify-center gap-3">
                        <p className="text-slate-500 text-xs font-semibold">
