      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-2xl bg-[#0b0f19]/95 border border-white/15 shadow-[0_24px_50px_rgba(0,0,0,0.3)] rounded-3xl overflow-hidden flex flex-col max-h-[90vh] backdrop-blur-xl"
          >
            {/* Header */}
