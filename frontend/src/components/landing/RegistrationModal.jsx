            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <motion.div 
                        ...
                        className="relative w-full max-w-lg bg-white border border-black/10 p-8 md:p-12 shadow-2xl rounded-3xl"
                    >
                        ...
                        {!success ? (
                            <div className="space-y-8">
                                <div className="space-y-2">
                                    <h2 className="text-3xl font-display font-bold tracking-tight">Abhi Register Karein</h2>
                                    <p className="text-ink-3 text-sm italic">Sahi updates sahi samay par milenge.</p>
                                </div>
                                ...
                                <button 
                                    ...
                                    disabled={loading}
                                    className="w-full bg-black text-white py-5 font-black uppercase tracking-widest hover:bg-black/90 transition-all flex items-center justify-center gap-3 active:scale-[0.98] rounded-xl"
                                >
                            ...
                            <div className="text-center py-8 space-y-8">
                                <div className="w-20 h-20 bg-success/10 text-success flex items-center justify-center rounded-full mx-auto">
                                    <CheckCircle2 size={40} />
                                </div>
                                <div className="space-y-4">
                                    <h2 className="text-4xl font-display font-bold">Setup Done!</h2>
                                ...
                                <div className="grid gap-3">
                                    <a 
                                        ...
                                        target="_blank" 
                                        className="w-full bg-black text-white py-4 font-black uppercase tracking-widest text-xs flex items-center justify-center gap-3 rounded-xl"
                                    >
                                        Join Telegram Bot <ArrowRight size={16} />
                                    </a>
                                    <a 
                                        href={`https://wa.me/${config.whatsapp_number || '916377964293'}`} 
                                        target="_blank" 
                                        className="w-full border-2 border-black text-black py-4 font-black uppercase tracking-widest text-xs flex items-center justify-center gap-3 rounded-xl"
                                    >
                                        WhatsApp Help <ArrowRight size={16} />
                                    </a>
                                </div>
                            </div>
                        )}
