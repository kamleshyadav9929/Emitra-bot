...
export default function LoginModal({ isOpen, onClose }) {
    ...
    const handleSendOtp = async () => {
        ...
        try {
            ...
            if (err.code === "auth/too-many-requests") {
                ...
                setError("Could not send OTP. Check that Phone Auth is enabled in Firebase.")
            }
            clearVerifier()
        } finally {
            setLoading(false)
    ...
    return (
        <>
            ...
            {/* reCAPTCHA v2 (invisible/legacy) — MUST be outside AnimatePresence, always in DOM */}
            <div id="recaptcha-container" style={{ position: "fixed", bottom: 0, left: 0, zIndex: 0 }} />
        </>
    )
}
